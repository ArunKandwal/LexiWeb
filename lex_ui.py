...
st.markdown("---")
tabs = st.tabs(["📝 Code Editor", "🧩 Tokens", "📊 Symbol Table"])

with tabs[0]:
    st.subheader("Edit or Paste Your Code")
    st.session_state.code_input = st.text_area("Write your code here", value=st.session_state.code_input, height=300)
